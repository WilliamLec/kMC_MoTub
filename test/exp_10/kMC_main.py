...
tick_max = 1*1*10**3 # Stop condiontion on loops 
...
occ, ersl = kMC.initialize_event_lists(lat, Nr,
...
tick_visu = 200 # number of loops between 2 frames
...
""" loop the simulation while the stop condition is not verifiedw²
"""
while tick < tick_max: 
    ...
    lat, occ, ersl = kMC.update_lattice_configuration(lat, occ, ersl, reac, loc, DIRECTIONALITY, TABLE_DEFECT, TABLE_NO_DEFECT)
