...
tick_max = 1*10**3 # Stop condiontion on loops 
...
occ, ersl = kMC.scan(lat, Nr, DIRECTIONALITY, TABLE_NO_DEFECT, TABLE_DEFECT)

""" Initialized observables 
"""
tick = 0 # number of loops 
tick_visu = 50 # number of loops between 2 frames
