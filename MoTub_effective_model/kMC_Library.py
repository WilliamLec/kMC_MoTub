...
def rate_constant_initizalition(HYDROLYSIS_TIME, k_DIMER_ATTACH, 
    ...
    """ Return the rate constant vector for MoTub model
        ...
        2 up to 62. effective koff for dimer w/out defect on same pf
        62 up to 92 effective koff for dimer w/ defect upstream
        92 up to 122 effective koff for dimer w/ defect downstream
    """
